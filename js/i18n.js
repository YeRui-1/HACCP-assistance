...
const I18n = (() => {
  ...
  const strings = {
    ...
    'admin.reports':        ['用户报告', 'User Reports'],
    'admin.reportsDesc':    ['查看和管理用户生成的 HACCP 报告', 'View and manage HACCP reports generated by users'],
    ...
    'fc.ingredients':       ['原料 / 辅料 / 添加剂', 'Ingredients / Additives'],
    'fc.ingName':           ['名称', 'Name'],
    'fc.ingNamePh':         ['如：牛肉', 'e.g. Beef'],
    'fc.ingAmount':         ['用量', 'Amount'],
    'fc.ingAmountPh':       ['如：100kg', 'e.g. 100kg'],
    'fc.ingPurpose':        ['作用', 'Purpose'],
    'fc.ingPurposePh':      ['如：主要原料', 'e.g. Main ingredient'],
    'fc.addIng':            ['+ 添加原料', '+ Add Ingredient'],
